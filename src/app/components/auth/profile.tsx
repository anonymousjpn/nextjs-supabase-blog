        ...
        <div className="max-w-sm mx-auto">
            <form onSubmit={onSubmit}>
                <div className="mb-5">
                    ...
                    <input type="file" id="tumbnail" onChange={onUploadImage}/>
                </div>
                <div className="mb-5">
                ...
                <div className="text-center mb-10">
                    {loading?(
                        ...
                        <button type="submit" className="w-full text-white bg-yellow-500 hover:brightness-110 rounded py-1 px-8">変更</button>
                    )}
                </div>
            </form>
