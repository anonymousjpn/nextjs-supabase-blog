                ...
                <div className="flex justify-end">
                    {loading ? (
                        ...
                        <div className="flex items-center space-x-5">
                            <Link href={`/blog/${blog.id}/edit`} className="bg-sky-500 rounded-md px-4 py-3">編集</Link>
                            <div className="cursor-pointer bg-red-500 rounded-md px-4 py-3" onClick={() => deleteBlog()}>
                                削除
                            </div>
                        </div>
                    )}
